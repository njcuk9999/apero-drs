...
# =============================================================================
class NirpsHe(instrument_mod.Instrument):
    # set class name
    class_name = 'NirpsHe'
...
def clean_obj_name(params: ParamDict, pconst: NirpsHe, header: Any = None,
...
def construct_dprtype(params: ParamDict, pconst: NirpsHe, filename: str,
                      header: Any,
...
def get_dprtype(params: ParamDict, pconst: NirpsHe, header: Any, hdict: Any,
                filename: Union[None, str, Path] = None) -> Tuple[Any, Any]:
    """
