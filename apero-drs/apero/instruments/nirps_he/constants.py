...
CDict.set('FIND_STARTDATE', value=59890, # 2022-11-07
          source=__NAME__, group=cgroup, author=base.AUTHORS['NJC'])
...
CDict.set('REF_FILETYPE', value=['DARK_DARK'], source=__NAME__, group=cgroup)
...
CDict.set('NSECTIONS', value=16, source=__NAME__, group=cgroup)

# Define the range of angles (in degrees) for the first iteration (large)
CDict.set('LANGLE_MIN', value=-20.0, source=__NAME__, group=cgroup)
CDict.set('LANGLE_MAX', value=20.0, source=__NAME__, group=cgroup)

# Define the range of angles (in degrees) for subsequent iterations (small)
CDict.set('SANGLE_MIN', value=-5.0, source=__NAME__, group=cgroup)
CDict.set('SANGLE_MAX', value=5.0, source=__NAME__, group=cgroup)
...
CDict.set('RV_THRES_QC', value=50000.0, source=__NAME__,
          author='EA', group=cgroup)
...
CDict.set('ALLOWED_DPRTYPES',
          value=[], source=__NAME__, group=cgroup)
...
CDict.set('ABSO_EXPO_KWID', value=4.5, source=__NAME__, group=cgroup)
