...
class NirpsHa(instrument_mod.Instrument):
    ...
    def get_clists(self) -> List[Any]:
        ...
        from apero.instruments.nirps_ha import keywords
        # get constants dicts
    ...
    def FILEMOD(self) -> Any:
        ...
        """
        # this has to be local
        from apero.instruments.nirps_ha import file_definitions
        # return import
        return file_definitions
    ...
    def RECIPEMOD(self) -> Any:
        ...
        """
        # this has to be local
        from apero.instruments.nirps_ha import recipe_definitions
        # return import
    ...
    def FIBER_SETTINGS(self, params: ParamDict, fiber: str) -> ParamDict:
        ...
        for key in keys:
            ...
            # if key exists add it for this fiber
                ...
                fiberparams[key] = params[key][fiber]
...
def clean_obj_name(params: ParamDict, pconst: NirpsHa,
                   header: Any = None,
...
def construct_dprtype(params: ParamDict, pconst: NirpsHa, filename: str,
                      header: Any,
...
def get_dprtype(params: ParamDict, pconst: NirpsHa, header: Any, hdict: Any,
                filename: Union[None, str, Path] = None) -> Tuple[Any, Any]:
    """
...
def set_apero_reldate(params: ParamDict, header: Any,
    ...
    tdelta = params['DATA.ARELDATE_DELTA']
