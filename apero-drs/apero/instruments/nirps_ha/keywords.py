...
KDict.set('KW_WAVE_MODE_FP', key='WAVFPMOD', comment='mode used to calc fp wave sol',
          parent='CAL.WAVE.FP.MODE_FP', group='wave')
...
KDict.set('KW_WAVE_HCG_SIGPEAK', key='WAVHGSPK',
          ...
          parent='CAL.WAVE.HC.HC_FITBOX_SIGMA', group='wave')
...
KDict.set('KW_WAVE_HCG_EWMIN', key='WAVHGEW0', comment='HC Gauss peak fit, e-width min',
          parent='CAL.WAVE.HC.HC_FITBOX_EWMIN', group='wave')
...
KDict.set('KW_TELLUP_DO_PRECLEAN', key='TLPDOFRC', comment='tellu finite res corr done',
          parent='OBJ.TELL.PCLEAN.DO_FINITE_RES_CORR')
