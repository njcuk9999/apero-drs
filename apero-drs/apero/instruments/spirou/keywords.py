...
KDict.set('KW_FP_VAC_PRESS', key='SECFPB_P',
...
KDict.set('KW_FP_HEATER_POWER', key='SECFPP_V',
...
KDict.set('KW_FP_TEMP_INT', key='SECFPI_T',
...
KDict.set('KW_FP_TEMP_EXT', key='SECFPE_T',
...
KDict.set('KW_IRELDATE', key='REL_DATE', comment='queue release date',
          group='raw', datatype='iso', dataformat='str')

# Define the APERO Public Release date (YYYY-MM-DD) this may be different
#  from raw file header's release date
KDict.set('KW_ARELDATE', key='ARELDATE',
...
KDict.set('KW_CDTFLAT', key='CDTFLAT', comment='MJDMID of cal FLAT file used')
