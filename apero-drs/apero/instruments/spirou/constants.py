...
CDict.set('FIRST_ORDER_JUMP', value=dict(AB=2, A=0, B=0, C=1),
          source=__NAME__, group=cgroup)

# Maximum number of order to use
CDict.set('MAX_NUM_ORDERS', value=dict(AB=98, A=49, B=49, C=49),
          source=__NAME__, group=cgroup)

# Number of fibers
CDict.set('SET_NUM_FIBERS', value=dict(AB=2, A=1, B=1, C=1),
          source=__NAME__, group=cgroup)
