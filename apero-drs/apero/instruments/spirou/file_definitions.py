...
# flat response file: per-order flat-response profile from convolve_irregular,
# produced during flat-field extraction; not stored in the calibration database
