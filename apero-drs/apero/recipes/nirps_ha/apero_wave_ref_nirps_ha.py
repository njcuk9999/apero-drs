...
# -*- coding: utf-8 -*-
"""
apero_wave_ref_nirps_ha.py [obs dir] [HC_HC files] [FP_FP files]

APERO wavelength solution reference calibration recipe for NIRPS HA
...
# Define variables
# =============================================================================
__NAME__ = 'apero_wave_ref_nirps_ha.py'
...
def __main__(recipe: DrsRecipe, params: ParamDict) -> Dict[str, Any]:
    ...
    for it in range(num_files):
        ...
        # Ref night B -> we force the coefficients to
        # be the ones found with A, fit_cavity = False,
