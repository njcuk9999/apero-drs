...
# -*- coding: utf-8 -*-
"""
apero_dark_ref_nirps_ha.py

Dark reference calibration recipe for NIRPS HE
...
# Define variables
# =============================================================================
__NAME__ = 'apero_dark_ref_nirps_he.py'
...
def __main__(recipe: DrsRecipe, params: ParamDict) -> Dict[str, Any]:
    ...
    allowedtypes = params['CAL.DARK.ALLOWED_TYPES']
