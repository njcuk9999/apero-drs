...
# -*- coding: utf-8 -*-
"""
apero_wave_night_spirou.py [obs dir] [HC_HC files] [FP_FP files]

APERO wavelength solution nightly calibration recipe for SPIROU
...
def __main__(recipe: DrsRecipe, params: ParamDict) -> Dict[str, Any]:
    ...
    for it in range(num_files):
        ...
        wout = wave.get_wavelines(params, recipe,
                                  ref_fiber, infile=hc_e2ds_file)
        ...
        wprops.set_source('SLINK_EW', mainname)
        # apply slinky correction
