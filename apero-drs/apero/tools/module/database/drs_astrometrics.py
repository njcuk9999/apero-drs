...
def identify_from_file(params: ParamDict) -> ParamDict:
    """
    Identify the object from a file by looking up the RA/DEC in Simbad
    
    :param params: ParamDict, parameter dictionary of constants

    :return: ParamDict, updated parameter dictionary of constants
    """
    # set function name
    ...
    if rawobjname is None and kwrawobjname not in header:
        ...
        raise AperoCodedException(params, '01-001-00027',
                                  targs=eargs)
