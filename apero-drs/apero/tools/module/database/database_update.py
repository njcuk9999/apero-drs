...
def _log_update_files(params: ParamDict, pconst: select.Instrument,
...
def _get_log_update_entry(params: ParamDict, pconst: select.Instrument,
                          filename: str):
    """
...
def _log_update_from_header(params: ParamDict, pconst: select.Instrument,
                            filename: str,
...
def _combine_log_entries(pconst: select.Instrument,
                         existing: List[Any],
...
def _is_header_log_entry(pconst: select.Instrument, entry: List[Any]) -> bool:
    """
