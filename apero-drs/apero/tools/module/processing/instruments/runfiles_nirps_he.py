...
def get_runfiles(params: ParamDict) -> List[RunIniFile]:
    ...
    science_run_nirps_he.modify('OBJ.LBL.RECAL_TEMPLATES', False)
    ...
    online_run_nirps_he.modify('OBJ.LBL.RECAL_TEMPLATES', False)
    ...
    tnc_run_nirps_he.modify('OBJ.LBL.RECAL_TEMPLATES', False)
    ...
    tns_run_nirps_he.modify('OBJ.LBL.RECAL_TEMPLATES', False)
