...
def get_runfiles(params: ParamDict) -> List[RunIniFile]:
    ...
    static_run_spirou.modify('RUN_PP_SCI', False)
    static_run_spirou.modify('RUN_PP_TEL', False)
    static_run_spirou.modify('RUN_PP_HC1HC1', False)
    static_run_spirou.modify('RUN_PP_FPFP', False)
    static_run_spirou.modify('RUN_PP_FF', False)
    static_run_spirou.modify('RUN_PP_DFP', False)
    static_run_spirou.modify('RUN_PP_SKY', False)
    ...
    static_run_spirou.modify('RUN_EXT_FF', False)
    static_run_spirou.modify('RUN_EXT_DFP', False)
    static_run_spirou.modify('RUN_EXT_FF', False)
    static_run_spirou.modify('RUN_EXT_FPD', False)
    static_run_spirou.modify('RUN_EXT_SKY', False)
    static_run_spirou.modify('RUN_EXT_LFC', False)
    static_run_spirou.modify('RUN_EXT_LFCFP', False)
    static_run_spirou.modify('RUN_EXT_FPLFC', False)
    static_run_spirou.modify('RUN_EXT_FPHC1', False)
    static_run_spirou.modify('RUN_EXT_HC1FP', False)
    static_run_spirou.modify('RUN_EXT_EVERY', False)
