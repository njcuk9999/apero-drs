...
def get_runfiles(params: ParamDict) -> List[RunIniFile]:
    ...
    science_run_spirou.modify('OBJ.LBL.RECAL_TEMPLATES', False)
    ...
    tnc_run_spirou.modify('OBJ.LBL.RECAL_TEMPLATES', False)
    ...
    tns_run_spirou.modify('OBJ.LBL.RECAL_TEMPLATES', False)
