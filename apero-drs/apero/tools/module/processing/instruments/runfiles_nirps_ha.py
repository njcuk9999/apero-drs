...
def get_runfiles(params: ParamDict) -> List[RunIniFile]:
    ...
    static_run_nirps_ha.modify('RUN_PP_SCI', False)
    static_run_nirps_ha.modify('RUN_PP_TEL', False)
    static_run_nirps_ha.modify('RUN_PP_HC1HC1', False)
    static_run_nirps_ha.modify('RUN_PP_FPFP', False)
    static_run_nirps_ha.modify('RUN_PP_FF', False)
    static_run_nirps_ha.modify('RUN_PP_DFP', False)
    static_run_nirps_ha.modify('RUN_PP_SKY', False)
    static_run_nirps_ha.modify('RUN_PP_LFC', False)
    static_run_nirps_ha.modify('RUN_PP_LFCFP', False)
    static_run_nirps_ha.modify('RUN_PP_FPLFC', False)
    static_run_nirps_ha.modify('RUN_PP_HC1FP', False)
    static_run_nirps_ha.modify('RUN_PP_EVERY', False)
    static_run_nirps_ha.modify('RUN_LEAKREF', False)
    static_run_nirps_ha.modify('RUN_WAVEREF', False)
    static_run_nirps_ha.modify('RUN_THERM_REFI', False)
    static_run_nirps_ha.modify('RUN_THERM_REFT', False)
    ...
    science_run_nirps_ha.modify('OBJ.LBL.RECAL_TEMPLATES', False)
    ...
    online_run_nirps_ha.append_sequence('lbl_seq')
    online_run_nirps_ha.modify('RUN_PPREF', False)
    online_run_nirps_ha.modify('RUN_PP_CAL', True)
    online_run_nirps_ha.modify('RUN_PP_SCI', True)
    online_run_nirps_ha.modify('RUN_PP_TEL', False)
    online_run_nirps_ha.modify('RUN_PP_HC1HC1', False)
    online_run_nirps_ha.modify('RUN_PP_FPFP', False)
    online_run_nirps_ha.modify('RUN_PP_FF', False)
    online_run_nirps_ha.modify('RUN_PP_DFP', False)
    online_run_nirps_ha.modify('RUN_PP_SKY', False)
    online_run_nirps_ha.modify('RUN_PP_LFC', False)
    online_run_nirps_ha.modify('RUN_PP_LFCFP', False)
    online_run_nirps_ha.modify('RUN_PP_FPLFC', False)
    online_run_nirps_ha.modify('RUN_PP_FPHC1', False)
    online_run_nirps_ha.modify('RUN_PP_HC1FP', False)
    online_run_nirps_ha.modify('RUN_PP_EVERY', False)
    online_run_nirps_ha.modify('OBJ.LBL.RECAL_TEMPLATES', False)
    online_run_nirps_ha.modify('CORES', 5)
    ...
    tnc_run_nirps_ha.modify('OBJ.LBL.RECAL_TEMPLATES', False)
    ...
    tns_run_nirps_ha.modify('OBJ.LBL.RECAL_TEMPLATES', False)
