...
\noindent following our example data architecture (from Section \ref{ch:install:setup} and shown explicitly in Section \ref{ch:data_architecture:folder_layout}) all files should be places in the \definevariable{text:drs_data_raw}{DRS\_DATA\_RAW} (\textcolor{blue}{/drs/data/raw} in our case).
...
\noindent which needs to be placed in the \definevariable{text:drs_calib_db}{DRS\_CALIB\_DB} directory (\textcolor{blue}{/drs/data/calibDB} in our case).
...
\noindent Therefore we need one (as stated in the above section). We use the ones from here:

\begin{cmdbox}
spirou@10.102.14.81:/data/reduced/DATA-CALIB/spirou_wave_ini3.fits
spirou@10.102.14.81:/data/.../AT4-04/2017-10-11_21-32-17 2017-10-11_21-32-17_hcone_hcone02c406_wave_AB.fits 
spirou@10.102.14.81:/data/.../AT4-04/2017-10-11_21-32-17 2017-10-11_21-32-17_hcone_hcone02c406_wave_C.fits
\end{cmdbox}
...
@WAVE_AB AT4-04/2017-10-11_21-32-17 2017-10-11_21-32-17_hcone_hcone02c406_wave_AB.fits 2014-08-11-03:42:12.000000 1407728532
