...
To do this one need to change the \definevariable{text:user_config}{USER\_CONFIG} parameter to 1 (or True). This tells the DRS to look for \definevariable{text:drs_uconfig} parameter either in the master config file (\configtxtfile) and in the system environment (for the variable `DRS\_UCONFIG').
