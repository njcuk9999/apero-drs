...
.3 bin \DTcomment{Recipes}.
.4 \calbadpix.
.5 \DTcomment{See Section \ref{ch:the_recipes:cal_BADPIX_spirou}}.
.4 \calCCF.
.5 \DTcomment{See Section \ref{ch:the_recipes:cal_CCF_E2DS_spirou}}.
.4 \calDARK.
.5 \DTcomment{See Section \ref{ch:the_recipes:cal_DARK_spirou}}.
.4 \calDRIFTRAW.
.5 \DTcomment{See Section \ref{ch:the_recipes:cal_DRIFT_RAW_spirou}}.
.4 \calDRIFTE.
.5 \DTcomment{See Section \ref{ch:the_recipes:cal_DRIFT_RAW_spirou}}.
.4 \calDRIFTPEAK.
.5 \DTcomment{See Section \ref{ch:the_recipes:cal_DRIFT_RAW_spirou}}.
.4 \calextractRAW.
.5 \DTcomment{See Section \ref{ch:the_recipes:cal_extract_RAW_spirou}}.
.4 \calextractRAWAB.
.5 \DTcomment{See Section \ref{ch:the_recipes:cal_extract_RAW_spirou}}.
.4 \calextractRAWC.
.5 \DTcomment{See Section \ref{ch:the_recipes:cal_extract_RAW_spirou}}.
.4 \calFFraw.
.5 \DTcomment{See Section \ref{ch:the_recipes:cal_FF_RAW_spirou}}.
.4 \calHC.
.5 \DTcomment{See Section \ref{ch:the_recipes:cal_HC_E2DS_spirou}}.
.4 \callocRAW.
.5 \DTcomment{See Section \ref{ch:the_recipes:cal_loc_RAW_spirou}}.
.4 \calSLIT.
.5 \DTcomment{See Section \ref{ch:the_recipes:cal_SLIT_spirou}}.
.4 \calvalidate.
.5 \DTcomment{See Section \ref{ch:the_recipes:cal_validate_spirou}}.
.4 \calWAVE.
.5 \DTcomment{See Section \ref{ch:the_recipes:cal_WAVE_E2DS_spirou}}.
}
\end{tcustomdir}
...
.3 \DTcomment{See Section \ref{ch:the_module:spirouBACK}}.
.2 spirouCDB \DTcomment{The SPIRou calibration database module}.
.3 \DTcomment{See Section \ref{ch:the_module:spirouCDB}}.
.2 spirouConfig \DTcomment{The SPIRou configuration tools module}.
.3 \DTcomment{See Section \ref{ch:the_module:spirouConfig}}.
.2 spirouCore \DTcomment{The SPIRou core modules}.
.3 \DTcomment{See Section \ref{ch:the_module:spirouCore}}.
.2 spirouEXTOR \DTcomment{The SPIRou extraction module}.
.3 \DTcomment{See Section \ref{ch:the_module:spirouEXTOR}}.
.2 spirouFLAT \DTcomment{The SPIRou Flat field module}.
.3 \DTcomment{See Section \ref{ch:the_module:spirouFLAT}}.
.2 spirouImage \DTcomment{The SPIRou image module}.
.3 \DTcomment{See Section \ref{ch:the_module:spirouImage}}.
.2 spirouLOCOR \DTcomment{The SPIRou localization module}.
.3 \DTcomment{See Section \ref{ch:the_module:spirouLOCOR}}.
.2 spirouRV \DTcomment{The SPIRou radial velocity module}.
.3 \DTcomment{See Section \ref{ch:the_module:spirouRV}}.
.2 spirouStartup \DTcomment{The SPIRou start up tools module}.
.3 \DTcomment{See Section \ref{ch:the_module:spirouStartup}}.
.2 spirouTHORCA \DTcomment{The SPIRou THORCA module}.
.3 \DTcomment{See Section \ref{ch:the_module:spirouTHORCA}}.
