...
\item Make sure \definevariable{text:user_config}{USER\_CONFIG} and \definevariable{text:drs_debug}{DRS\_DEBUG} are set to a value of 0 (or False) and that \definevariable{text:icdp_name}{ICDP\_NAME} is set to `constants\_SPIROU.py'.
...
\item Add the following paths to your PATH and PYTHON PATH environmental variables (in for example .bashrc or \path{.bash_profile})
