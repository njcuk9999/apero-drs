...
% IC_FP_N_ORD_FINAL
\item \namedlabel{text:} \ParameterEntry{FP solution - last order}
...
% IC_FP_FIT_DEGREE
\item \namedlabel{text:} \ParameterEntry{FP solution - poly-fit degree}
...
% IC_FP_LARGE_JUMP
\item \namedlabel{text:} \ParameterEntry{FP solution - large jump size}
