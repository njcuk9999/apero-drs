...
\begin{itemize}
	...
	{The full path of the processed dark bad pixel map calibration file}
	{darkbadpixfile}
...
% blazefits
\begin{itemize}
	\item \namedlabel{text:blazefits} \PseudoParamEntry{Blaze file}
...
% flatfits
\begin{itemize}
	\item \namedlabel{text:flatfits} \PseudoParamEntry{Flat file}
