...
\item \ParameterEntry{Selected order for linelist vs log Amplitude plot}
...
% darkfile
\begin{itemize}
	\item \namedlabel{text:darkfile} \PseudoParamEntry{The dark calibration file}
...
% badpixelfits
\begin{itemize}
	\item \namedlabel{text:badpixelfits} \PseudoParamEntry{The bad pixel map calibration file}
	{The full path of the bad pixel map calibration file}
	{badpixfile}
...
% order_profile
\begin{itemize}
	\item \namedlabel{text:order_profile} \PseudoParamEntry{The order profile image file}
...
% locofits
\begin{itemize}
	\item \namedlabel{text:locofitsfile} \PseudoParamEntry{Localization file 1}
	{The full path of the localisation file containing the center fits for each order.}
	{locofits}
...
% locofits2
\begin{itemize}
	\item \namedlabel{text:locofitsfile2} \PseudoParamEntry{Localization file 2}
	{The full path of the localisation file containing the width fits for each order}
	{locofits2}
...
% locofits3
\begin{itemize}
	\item \namedlabel{text:locofitsfile3} \PseudoParamEntry{Localization file 3}
...
% tiltfits
\begin{itemize}
	\item \namedlabel{text:tiltfits} \PseudoParamEntry{Tilt file}
	{The full path of the tilt file.}
	{tiltfits}
...
% blazefits
% \begin{itemize}
% 	\item \namedlabel{text:} \PseudoParamEntry{}
% 	{}
% 	{}
% 	{\cal}{\spirouConst.}{\cal}
% \end{itemize}
