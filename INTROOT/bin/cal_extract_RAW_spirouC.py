...
Extracts order C for specified files. Wrapper around cal_extract_RAW_spirou.py
...
Up-to-date with cal_extract_RAW_spirouC AT-4 V47
"""
...
if __name__ == "__main__":
    ...
    ll = cal_extract_RAW_spirou.main(fiber_type='C',
                                     ic_extract_type='all',
                                     ic_ext_sigdet=-1)
