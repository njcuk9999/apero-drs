...
def add_calib_page(params, recipe_table):
    ...
    # add page access
    calib_page.add_html(ari_pages.add_page_access(recipe_table.params['ARI_GROUP']))
    # -----------------------------------------------------------------
    # Add basic text
...
def create_plots(params, calib_props) -> List[ari_plot.DebugPlot]:
...
def get_prev_data(calib_key_file) -> Dict[str, Any]:
    # -------------------------------------------------------------------------
...
def get_calib_hkeys(params, calib_data, calib_files) -> Dict[str, Any]:
