...
def resolve_target(params: ParamDict, pconst: PseudoConst,
    ...
    if len(table) == 0:
        objname = cobjname
        original_name = header[params['KW_OBJECTNAME'][0]]
        ra_deg = header[params['KW_OBJRA'][0]]
        ra_source = 'header'
        dec_deg = header[params['KW_OBJDEC'][0]]
        dec_source = 'header'
        epoch = pconst.GET_EPOCH(params, header)
        pmra = header[params['KW_OBJRAPM'][0]]
        pmra_source = 'header'
        pmde = header[params['KW_OBJDECPM'][0]]
        pmde_source = 'header'
...
# def resolve_target_old(params: ParamDict, pconst: PseudoConst,
#                    objname: Union[str, None] = None,
#                    database: Union[ObjectDatabase, None] = None,
#                    header: Union[drs_fits.Header, None] = None
#                    ) -> Union[drs_fits.Header, None]:
