...
# -*- coding: utf-8 -*-
"""
apero_dark_spip.py [obs dir] [ files]

Dark calibration recipe for SPIP (Currently not used)
...
def __main__(recipe: DrsRecipe, params: ParamDict) -> Dict[str, Any]:
    ...
    # check qc
    infiles = drs_file.check_input_qc(params, infiles, 'dark files')
