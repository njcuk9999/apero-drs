...
# -*- coding: utf-8 -*-
"""
apero_postprocess_spip.py [obs_dir] [files]

APERO post processing recipe for SPIP
...
from apero.core.instruments.spip import file_definitions as fd
...
# Define variables
# =============================================================================
__NAME__ = 'apero_postprocess_spip.py'
__INSTRUMENT__ = 'SPIP'
...
def main(obs_dir: Optional[str] = None, files: Optional[List[str]] = None,
    ...
    """
    Main function for apero_badpix_spip.py
