...
# -*- coding: utf-8 -*-
"""
apero_preprocess_spip.py [obs dir] [files]

APERO pre-processing of raw images for SPIP
...
# Define variables
# =============================================================================
__NAME__ = 'apero_preprocess_spip.py'
__INSTRUMENT__ = 'SPIP'
...
def __main__(recipe: DrsRecipe, params: ParamDict) -> Dict[str, Any]:
    ...
    for it in range(num_files):
        ...
        # Fix the header
        # ------------------------------------------------------------------
        # certain keys may not be in some spip files
