...
APERO shape reference calibration recipe for SPIP
...
# Define variables
# =============================================================================
__NAME__ = 'apero_shape_ref_spip.py'
__INSTRUMENT__ = 'SPIP'
...
def main(obs_dir: Optional[str] = None, hcfiles: Optional[List[str]] = None,
    ...
    """
    Main function for apero_shape_ref_spip.py
...
def __main__(recipe: DrsRecipe, params: ParamDict) -> Dict[str, Any]:
    ...
    # ----------------------------------------------------------------------
    dout = shape.calculate_dxmap(params, recipe, ref_fp, lprops_all, fiber)
