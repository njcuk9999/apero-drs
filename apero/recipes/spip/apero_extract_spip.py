...
# -*- coding: utf-8 -*-
"""
apero_extract_spip.py [obs dir] [ files]

APERO extraction recipe for SPIP
...
# Define variables
# =============================================================================
__NAME__ = 'apero_extract_spip.py'
__INSTRUMENT__ = 'SPIP'
        ...
        for fiber in fibertypes:
            ...
            if not quicklook:
                mp2p_e2ds = extract.measure_p2p_scat(params, wprops['WAVEMAP'],
                                                     eprops['E2DS'])
                mp2p_e2dsff = extract.measure_p2p_scat(params, wprops['WAVEMAP'],
                                                       eprops['E2DSFF'])
