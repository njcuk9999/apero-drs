...
# -*- coding: utf-8 -*-
"""
apero_wave_ref_spip.py [obs dir] [HC_HC files] [FP_FP files]

APERO wavelength solution reference calibration recipe for SPIP
...
# Define variables
# =============================================================================
__NAME__ = 'apero_wave_ref_spip.py'
__INSTRUMENT__ = 'SPIP'
...
EXTRACT_NAME = 'apero_extract_spip.py'
# Speed of light
