...
# -*- coding: utf-8 -*-
"""
apero_flat_nirps_he.py [obs dir] [files]

APERO flat and blaze finding recipe for NIRPS HE
...
# Define variables
# =============================================================================
__NAME__ = 'apero_flat_nirps_he.py'
...
def __main__(recipe: DrsRecipe, params: ParamDict) -> Dict[str, Any]:
    ...
    # combine input images if required
        ...
        # get combined file
        cond = drs_file.combine(params, recipe, infiles, math='sum',
