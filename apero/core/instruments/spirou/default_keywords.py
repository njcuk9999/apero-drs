...
KW_NIGHT_OBS.set('KW_NIGHT_OBS', key='DRS_NOBS',
...
KW_CIV_TWIL.set('KW_CIV_TWIL', key='DRSCTWIL', group='raw-add',
...
KW_NAU_TWIL.set('KW_NAU_TWIL', key='DRSNTWIL', group='raw-add',
...
KW_AST_TWIL.set('KW_AST_TWIL', key='DRSATWIL', group='raw-add',
...
KW_SUN_ELEV.set('KW_SUN_ELEV', key='DRSSUNEL', group='raw-add',
