"""
Default constants for ILOCATER
...
__NAME__ = 'core.instruments.ilocater.default_constants.py'
...
PP_AMP_ERROR_MODEL.value = 'static_dark_curr_ilocater.fits.gz'
