...
#       in import * module
__NAME__ = 'config.instruments.ilocater.default_keywords.py'
...
KW_IDENTIFIER.set(key='IDENTIFI',
...
KW_MJDATE.set(key='MJDSTART', datatype='mjd', dataformat=float,
...
KW_INST_MODE.set(key='NULL', comment='Instrument mode used',
                 group='raw')
...
KW_OBJRA.set(key='CRA1', unit=uu.deg, comment='Target right ascension',
             group='raw')

# define the observation dec HEADER key
KW_OBJDEC = KW_OBJDEC.copy(__NAME__)
KW_OBJDEC.set(key='CDEC1', unit=uu.deg, comment='Target declination ',
              group='raw')
...
KW_OBJECTNAME2.set(key='NULL', comment='OB target name',
                   group='raw')
