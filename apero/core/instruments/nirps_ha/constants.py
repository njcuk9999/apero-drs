...
__NAME__ = 'core.instruments.nirps_ha.constants.py'
...
PP_OBJ_DPRTYPES.value = ['OBJ_DARK', 'OBJ_FP', 'OBJ_SKY', 'TELLU_SKY',
                         'FLUXSTD_SKY']
...
TELLU_ALLOWED_DPRTYPES.value = ['OBJ_DARK', 'OBJ_FP', 'OBJ_SKY', 'TELLU_SKY',
                                'FLUXSTD_SKY']
