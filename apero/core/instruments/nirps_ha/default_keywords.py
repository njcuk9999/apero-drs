...
KW_OBSTYPE.set(key='HIERARCH ESO DPR TYPE', comment='Observation type')
...
KW_CMPLTEXP.set(key='HIERARCH ESO TPL EXPNO',
                comment='Exposure number within template')
