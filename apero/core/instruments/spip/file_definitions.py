...
# -*- coding: utf-8 -*-
"""
APERO DrsFile definitions for SPIP
...
# Define variables
# =============================================================================
__NAME__ = 'config.instruments.spip.file_defintions.py'
__INSTRUMENT__ = 'SPIP'
...
lbl_template_file = drs_linput('LBL_TEMPLATE', path='templates',
                              filetype='.fits',
                              basename='LBL_Template_{obj}_spip',
                              datatype='table',
                              outclass=lbl_ofile,
                              description='Telluric 1D template file',
                              required=False)
...
lbl_mask_file = drs_linput('LBL_MASK',
                          ...
                          basename='LBL_MASK_{obj}_spip', datatype='table',
                          outclass=lbl_ofile,
