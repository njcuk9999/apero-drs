...
# -*- coding: utf-8 -*-
"""
APERO Recipe definitions for SPIP
...
from apero.core.instruments.spip import file_definitions as files
from apero.core.utils import drs_recipe

# =============================================================================
# Define variables
# =============================================================================
__NAME__ = 'core.instruments.spip.recipe_definitions.py'
__INSTRUMENT__ = 'SPIP'
...
INSTRUMENT_ALIAS = 'spip'
# Get Help
textentry = lang.textentry
# import file definitions in import module class
sf = base_class.ImportModule('spip.file_definitions',
                             'apero.core.instruments.spip.file_definitions',
                             mod=files)
...
# documentation
apero_preprocess.schematic = 'apero_preproces_spip_schematic.jpg'
apero_preprocess.description_file = 'apero_preprocess_spip.rst'
# add to recipe
...
# documentation
apero_badpix.schematic = 'apero_badpix_spip_schematic.jpg'
# add to recipe
...
# documentation
apero_dark_ref.schematic = 'apero_dark_ref_spip_schematic.jpg'
# add to recipe
...
# documentation
apero_loc.schematic = 'apero_loc_spip_schematic.jpg'
# add to recipe
...
apero_shape_ref.set_min_nfiles('fpfiles', 5)
...
# documentation
apero_shape_ref.schematic = 'apero_shape_ref_spip_schematic.jpg'
# add to recipe
...
# documentation
apero_shape.schematic = 'apero_shape_spip_schematic.jpg'
# add to recipe
...
# documentation
apero_flat.schematic = 'apero_flat_spip_schematic.jpg'
# add to recipe
...
thermal_dict = dict()
thermal_dict['fibers'] = sci_fibers + cal_fibers
thermal_dict['ARG'] = dict(zip(thermal_dict['fibers'],
                               ['fiber'] * len(thermal_dict['fibers'])))
apero_thermal.set_output_data(THERMAL_E2DS_FILE=thermal_dict,
                              THERMALI_FILE=thermal_dict,
                              THERMALT_FILE=thermal_dict)
...
# documentation
apero_thermal.schematic = 'apero_thermal_spip_schematic.jpg'
# add to recipe
...
apero_wave_ref.set_min_nfiles('fpfiles', 5)
apero_wave_ref.set_min_nfiles('hcfiles', 2)
...
# documentation
apero_wave_ref.schematic = 'apero_wave_ref_spip_schematic.jpg'
# add to recipe
...
apero_lbl_ref.in_block_str = 'red'
apero_lbl_ref.out_block_str = 'lbl'
apero_lbl_ref.extension = 'fits'
...
apero_lbl_mask.in_block_str = 'red'
apero_lbl_mask.out_block_str = 'lbl'
apero_lbl_mask.extension = 'fits'
...
apero_lbl_compute.in_block_str = 'red'
apero_lbl_compute.out_block_str = 'lbl'
apero_lbl_compute.extension = 'fits'
...
apero_lbl_compile.in_block_str = 'red'
apero_lbl_compile.out_block_str = 'lbl'
apero_lbl_compile.extension = 'fits'
...
full_seq.add(apero_thermal, name='THERM_REFI', ref=True,
...
full_seq.add(apero_thermal, name='THERM_REFT', ref=True,
...
full_seq.add(apero_pol, rkwargs=dict(exposures=[files.out_tellu_obj]),
...
limited_seq.add(apero_flat, name='FLATREF', ref=True,
                recipe_kind='calib-reference')
# thermal just for the FP_FP and HC_HC files (DARK_DARK_INT)
limited_seq.add(apero_thermal, name='THERM_REFI', ref=True,
                recipe_kind='calib-reference-I', files=[files.pp_dark_dark_int])
...
limited_seq.add(apero_wave_ref, ref=True,
                rkwargs=dict(hcfiles=[files.pp_hc1_hc1],
                             fpfiles=[files.pp_fp_fp]))
# thermal for everything else (requires a wave solution)
limited_seq.add(apero_thermal, name='THERM_REFT', ref=True,
                recipe_kind='calib-reference-T', files=[files.pp_dark_dark_tel],
                calib_required=False)
# night runs
...
limited_seq.add(apero_pol, rkwargs=dict(exposures=[files.out_tellu_obj]),
                recipe_kind='polar-tcorr', fiber=ref_fiber,
                filters=dict(KW_DPRTYPE=['POLAR_FP', 'POLAR_DARK'],
                             KW_OBJNAME='SCIENCE_TARGETS'))
