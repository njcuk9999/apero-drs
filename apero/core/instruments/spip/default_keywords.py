...
#       in import * module
__NAME__ = 'config.instruments.spip.default_keywords.py'
...
KW_CDEN.set(key='SBCDEN_P',
            comment='SPIP Calib-Reference density (0 to 3.3)', group='raw')
...
KW_CASS_TEMP.set(key='SB_POL_T',
                 comment='SPIP tpolar temp at start of exp (deg C)  ',
                 group='raw')
...
KW_IRELDATE.set(key='REL_DATE', comment='queue release date', group='raw',
