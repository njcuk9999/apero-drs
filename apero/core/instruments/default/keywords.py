...
KDict.set('KW_IDENTIFIER', key='NULL', value=None, source=__NAME__,
...
KDict.set('KW_DRS_RV_S', key='NULL', dtype=str, source=__NAME__,
...
KDict.set('KW_DRS_SPTYPE_S', key='NULL', dtype=str,
          source=__NAME__,
...
# -----------------------------------------------------------------------------
# input files
KDict.set('KW_INFILE1', key='NULL', dtype=str, source=__NAME__,
          description='input files')
KDict.set('KW_INFILE2', key='NULL', dtype=str, source=__NAME__,
          description='input files')
KDict.set('KW_INFILE3', key='NULL', dtype=str, source=__NAME__,
          description='input files')
...
KDict.set('KW_OUTPUT', key='NULL', dtype=str, source=__NAME__,
          description='the output key for drs outputs')

# the config run file used (if given)
KDict.set('KW_CRUNFILE', key='NULL', dtype=str, source=__NAME__,
...
# -----------------------------------------------------------------------------
# the drs qc
KDict.set('KW_DRS_QC', key='NULL', dtype=str, source=__NAME__,
          description='the drs qc ')
# the value of the qc
KDict.set('KW_DRS_QC_VAL', key='NULL', dtype=str, source=__NAME__,
          description='the value of the qc')
# the name of the quality control parameter
KDict.set('KW_DRS_QC_NAME', key='NULL', dtype=str, source=__NAME__,
          description='the name of the quality control '
                      'parameter')
# the logic of the quality control parameter
KDict.set('KW_DRS_QC_LOGIC', key='NULL', dtype=str, source=__NAME__,
          description='the logic of the quality control '
                      'parameter')
# whether this quality control parameter passed
KDict.set('KW_DRS_QC_PASS', key='NULL', dtype=str, source=__NAME__,
...
KDict.set('KW_PPSHIFTX', key='NULL', dtype=float, source=__NAME__,
          description=('The shift in pixels so that image is at '
                       'same location as engineering flat'))
KDict.set('KW_PPSHIFTY', key='NULL', dtype=float, source=__NAME__,
          description=('The shift in pixels so that image is at '
                       'same location as engineering flat'))

# the number of bad pixels found via the intercept (cosmic ray rejection)
KDict.set('KW_PPC_NBAD_INTE', key='NULL', dtype=int,
          source=__NAME__,
...
KDict.set('KW_PP_REF_NSIG', key='NULL', dtype=float, source=__NAME__,
...
KDict.set('KW_PP_REF_FILE', key='NULL', dtype=str, source=__NAME__,
...
KDict.set('KW_PP_LED_FLAT_P50', key='NULL', dtype=float,
          source=__NAME__,
...
KDict.set('KW_PP_LED_FLAT_P16', key='NULL', dtype=float,
          source=__NAME__,
          description='Define the percentile stats for LED '
                      'flat in pp (16th percentile)')

# Define the percentile stats for LED flat in pp (84th percentile)
KDict.set('KW_PP_LED_FLAT_P84', key='NULL', dtype=float,
          source=__NAME__,
          description='Define the percentile stats for LED '
                      'flat in pp (84th percentile)')

# Define the LED flat file used
KDict.set('KW_PP_LED_FLAT_FILE', key='NULL', dtype=str,
          source=__NAME__,
...
KDict.set('KW_SHAPE_DX', key='NULL', dtype=float, source=__NAME__,
          description='Shape transform dx parameter')

# Shape transform dy parameter
KDict.set('KW_SHAPE_DY', key='NULL', dtype=float, source=__NAME__,
          description='Shape transform dy parameter')

# Shape transform A parameter
KDict.set('KW_SHAPE_A', key='NULL', dtype=float, source=__NAME__,
          description='Shape transform A parameter')

# Shape transform B parameter
KDict.set('KW_SHAPE_B', key='NULL', dtype=float, source=__NAME__,
          description='Shape transform B parameter')

# Shape transform C parameter
KDict.set('KW_SHAPE_C', key='NULL', dtype=float, source=__NAME__,
          description='Shape transform C parameter')

# Shape transform D parameter
KDict.set('KW_SHAPE_D', key='NULL', dtype=float, source=__NAME__,
...
KDict.set('KW_LEAK_WSMOOTH', key='NULL', dtype=float,
          source=__NAME__,
...
KDict.set('KW_WFP_MASKWID', key='NULL', dtype=float, source=__NAME__,
...
KDict.set('KW_WFP_MASKUNITS', key='NULL', dtype=str,
          source=__NAME__,
...
KDict.set('KW_WNT_NITER1', key='NULL', dtype=int, source=__NAME__,
...
KDict.set('KW_RESMAP_NBO', key='NULL', dtype=int, source=__NAME__,
...
KDict.set('KW_RESMAP_NBINORD', key='NULL', dtype=int,
          source=__NAME__,
...
KDict.set('KW_RESMAP_BINPIX', key='NULL', dtype=int,
          source=__NAME__,
...
KDict.set('KW_RESMAP_NBINPIX', key='NULL', dtype=int,
          source=__NAME__,
...
KDict.set('KW_HAS_SKY_SCI', key='NULL', dtype=bool,
          source=__NAME__,
...
KDict.set('KW_HAS_SKY_CAL', key='NULL', dtype=bool,
          source=__NAME__,
          description='Defines whether we have a sky correction '
                      'for the science fiber')

# Defines which fiber was used for the science fiber sky correction model
KDict.set('KW_SKY_SCI_FIBER', key='NULL', dtype=str,
          source=__NAME__,
...
KDict.set('KW_SKY_CAL_FIBER', key='NULL', dtype=str,
          source=__NAME__,
          description='Defines which fiber was used for the '
                      'science fiber sky correction model')
...
KDict.set('KW_TELLUP_EXPO_WATER', key='NULL', dtype=float,
          source=__NAME__,
...
KDict.set('KW_TELLUP_EXPO_OTHERS', key='NULL', dtype=float,
          source=__NAME__,
...
KDict.set('KW_TELLUP_DV_WATER', key='NULL', dtype=float,
          source=__NAME__,
          description=(
...
#     preclean process
KDict.set('KW_TELLUP_DV_OTHERS', key='NULL', dtype=float,
          source=__NAME__,
          description=(
...
KDict.set('KW_TELLUP_CCFP_WATER', key='NULL', dtype=float,
          source=__NAME__,
          description=('Define the ccf power of the '
                       'water'))

# Define the ccf power of the others
KDict.set('KW_TELLUP_CCFP_OTHERS', key='NULL', dtype=float,
          source=__NAME__,
          description=('Define the ccf power of the '
                       'others'))

# Define whether precleaning was done (tellu pre-cleaning)
KDict.set('KW_TELLUP_DO_PRECLEAN', key='NULL', dtype=bool,
          source=__NAME__,
...
KDict.set('KW_TELLUP_DO_FINITE_RES', key='NULL',
...
KDict.set('KW_TELLUP_REMOVE_ORDS', key='NULL', dtype=str,
          source=__NAME__,
...
KDict.set('KW_TELLUP_SNR_MIN_THRES', key='NULL',
          dtype=float, source=__NAME__,
...
KDict.set('KW_TELLUP_ABSOEXPO_KTHRES', key='NULL',
          dtype=int, source=__NAME__,
...
KDict.set('KW_TELLUP_ABSOEXPO_KWID', key='NULL',
          dtype=float, source=__NAME__,
          description=(
...
KDict.set('KW_TELLUP_ABSOEXPO_KEXP', key='NULL',
          dtype=float, source=__NAME__,
          description=(
...
KDict.set('KW_TELLUP_TRANS_THRES', key='NULL',
          dtype=float, source=__NAME__,
          description=(
...
KDict.set('KW_TELLUP_TRANS_SIGL', key='NULL',
          dtype=float, source=__NAME__,
          description=(
...
KDict.set('KW_TELLUP_FORCE_AIRMASS', key='NULL',
          dtype=bool, source=__NAME__,
          description=(
...
KDict.set('KW_TELLUP_OTHER_BOUNDS', key='NULL',
...
KDict.set('KW_TELLUP_WATER_BOUNDS', key='NULL',
          dtype=str, source=__NAME__,
...
KDict.set('KW_MKTELL_DEF_CONV_WID', key='NULL', dtype=int,
          source=__NAME__,
...
KDict.set('KW_MKTELL_TEMP_MEDFILT', key='NULL', dtype=float,
          source=__NAME__,
          description=('The median filter width used '
                       'for mktellu calculation'))

# The recovered airmass value calculated in mktellu calculation
KDict.set('KW_MKTELL_AIRMASS', key='NULL', dtype=float,
          source=__NAME__,
...
KDict.set('KW_FTELLU_ABSO_SRC', key='NULL', dtype=str,
          source=__NAME__,
...
KDict.set('KW_MKTEMP_SNR_THRES', key='NULL', dtype=float,
          source=__NAME__,
          description=(
...
KDict.set('KW_MKTEMP_BERV_COV', key='NULL', dtype=float,
          source=__NAME__,
...
KDict.set('KW_MKTEMP_BERV_COV_MIN', key='NULL', dtype=float,
          source=__NAME__,
...
KDict.set('KW_MKTEMP_BERV_COV_SNR', key='NULL', dtype=float,
          source=__NAME__,
          description=('the core snr used for this '
                       'template calculation'))

# the resolution used for this template calculation
KDict.set('KW_MKTEMP_BERV_COV_RES', key='NULL', dtype=float,
          source=__NAME__,
...
KDict.set('KW_CCF_SIGDET', key='NULL', dtype=float, source=__NAME__,
...
KDict.set('KW_CCF_BOXSIZE', key='NULL', dtype=int, source=__NAME__,
          description=(
...
#   noise calculation
KDict.set('KW_CCF_MAXFLUX', key='NULL', dtype=float, source=__NAME__,
          description=(
...
KDict.set('KW_CCF_RV_SIMU_FP', key='NULL', dtype=float,
          source=__NAME__,
          description=(
...
KDict.set('KW_CCF_RV_DRIFT', key='NULL', dtype=float,
          source=__NAME__,
          description=(
...
KDict.set('KW_CCF_RV_OBJ', key='NULL', dtype=float, source=__NAME__,
...
KDict.set('KW_CCF_RV_CORR', key='NULL', dtype=float, source=__NAME__,
...
KDict.set('KW_CCF_RV_WAVEFILE', key='NULL', dtype=str,
          source=__NAME__,
          description=('the wave file used for the rv '
                       '(fiber specific)'))

# the wave file time used for the rv [mjd] (fiber specific)
KDict.set('KW_CCF_RV_WAVETIME', key='NULL', dtype=str,
          source=__NAME__,
...
KDict.set('KW_CCF_RV_TIMEDIFF', key='NULL', dtype=str,
          source=__NAME__,
...
KDict.set('KW_CCF_RV_WAVESRCE', key='NULL', dtype=str,
          source=__NAME__,
...
KDict.set('KW_POL_CONT_DEG_POLY', key='NULL', dtype=int,
          source=__NAME__,
...
KDict.set('KW_POL_S_IRAF_FUNC', key='NULL', dtype=str,
          source=__NAME__,
...
KDict.set('KW_POL_P_IRAF_FUNC', key='NULL', dtype=str,
          source=__NAME__,
...
KDict.set('KW_POL_S_IRAF_DEGREE', key='NULL', dtype=int,
          source=__NAME__,
...
KDict.set('KW_POL_P_IRAF_DEGREE', key='NULL', dtype=int,
          source=__NAME__,
          description='define the degree of the '
...
KDict.set('KW_LSD_NORM_WEIGHT', key='NULL',
          dtype=float, source=__NAME__,
