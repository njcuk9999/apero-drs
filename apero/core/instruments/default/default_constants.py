...
__all__ = [
    ...
    'REPROCESS_MP_LOGDB', 'REPROCESS_MP_CALIB',
...
CALIB_BIN_IN_TIME = Const('CALIB_BIN_IN_TIME', value=None, dtype=bool,
                          source=__NAME__, group=cgroup,
...
REPROCESS_REJECT_SQL = Const('REPROCESS_REJECT_SQL', value=None, dtype=str,
                             source=__NAME__, group=cgroup,
