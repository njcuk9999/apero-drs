"""
Default parameters for NIRPS HE
...
#       in import * module
__NAME__ = 'config.instruments.nirps_he.default_config.py'
...
OBS_TZ.value = 'Chile/Continental'
