...
class Colors:
    ...
    """
    BLACK1 = base.COLOURS['BLACK1']
    RED1 = base.COLOURS['RED1']
    GREEN1 = base.COLOURS['GREEN1']
    YELLOW1 = base.COLOURS['YELLOW1']
    BLUE1 = base.COLOURS['BLUE1']
    MAGENTA1 = base.COLOURS['MAGENTA1']
    CYAN1 = base.COLOURS['CYAN1']
    WHITE1 = base.COLOURS['WHITE1']
    BLACK2 = base.COLOURS['BLACK2']
    RED2 = base.COLOURS['RED2']
    GREEN2 = base.COLOURS['GREEN2']
    YELLOW2 = base.COLOURS['YELLOW2']
    BLUE2 = base.COLOURS['BLUE2']
    MAGENTA2 = base.COLOURS['MAGENTA2']
    CYAN2 = base.COLOURS['CYAN2']
    WHITE2 = base.COLOURS['WHITE2']
    ENDC = base.COLOURS['ENDC']
    BOLD = base.COLOURS['BOLD']
    UNDERLINE = base.COLOURS['UNDERLINE']
