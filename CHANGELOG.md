...
================================================================================
	...
	- extract_trigger.py - make test run - with printing/storing of commands only and add/modify printing/logging statements (rev.bed912eb)
	- extract_trigger.py - correct problem with preprocess trig (rev.353fa5f1)
	- extract_trigger - fix bugs (rev.f86503fd)
	- extract_trigger - fix mistake (rev.f7402c00)
	- extract_trigger - correct mistake in ask function (rev.fee6f048)
	- extract_trigger.py - allow to skip pp and make function (rev.3f03a1da)
	- extract_trigger.py - first working version (rev.f43d4563)
...
================================================================================
	...
	- extract_trigger.py - full calibration trigger test (rev.e51476d4)
	- extract_trigger.py - update imports (rev.60a570a3)
	- extract_trigger.py - use spirouUnitRecipes to run recipes (rev.74bcc402)
	- extract_trigger.py - print the error (rev.3fe34777)
	- extract_trigger.py - print output before running (rev.0acbeb0f)
	- extract_trigger.py - changes to test run printing (rev.ee0d2f79)
	- extract_trigger.py - fix for when there are no files found (rev.bc6e956f)
