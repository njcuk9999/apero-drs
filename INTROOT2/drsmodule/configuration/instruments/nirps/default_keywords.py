...
KW_ACQTIME_FMT = KW_ACQTIME_FMT.copy()
...
# -----------------------------------------------------------------------------
# DRS version
KW_VERSION = KW_VERSION.copy()
KW_VERSION.set(key='VERSION', comment='DRS version')

KW_PPVERSION = KW_PPVERSION.copy()
