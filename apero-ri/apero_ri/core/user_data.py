...
------
~/.ari/users/{username}/
    links.yaml          {sections: [], types: {}, links: {section: {name: {url, type, description}}}}
    notes/
        {id}.md         YAML front-matter delimited markdown files
    calendar.yaml       {events: [{id, title, date, time, color, category, recurrence, status}]}
...
def add_link(username: str, section: str, name: str,
             url: str, link_type: str = '', description: str = '') -> Dict:
...
def update_link(username: str, section: str, name: str,
                new_name: str, url: str, link_type: str = '',
...
def add_instrument_link(instrument: str, section: str, name: str,
                        url: str, link_type: str = '',
                        description: str = '') -> Dict:
    ...
    data['links'].setdefault(section, {})
    data['links'][section][name] = {
        'url': url, 'type': link_type, 'description': description,
    }
    save_instrument_links(instrument, data)
    return data


def update_instrument_link(instrument: str, section: str, name: str,
                           new_name: str, url: str,
                           link_type: str = '',
                           description: str = '') -> Dict:
    data = load_instrument_links(instrument)
...
def _note_to_file_text(note: Dict) -> str:
    ...
    return f"{_FM_SEP}\n{yaml.dump(front, default_flow_style=False, allow_unicode=True)}{_FM_SEP}\n{content}"
...
def manage_todo_metadata(username: str,
                         kind: str,
                         op: str,
                         value: str) -> Dict:
    data = load_todo(username)
