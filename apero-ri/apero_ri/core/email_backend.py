...
smtp_tls: false          # true = STARTTLS (port 587)
                        # ignored when smtp_ssl true
smtp_user: you@gmail.com
# smtp_password is stored in {ARI_DIR}/secret/smtp_password.enc
# via save_email_config().
...
PROVIDER_DEFAULTS = {
    "gmail": {
        ...
        "help_steps": [
            ...
            "then click Generate.",
            "Copy the 16-character password shown - this is your SMTP "
            "password.",
            "You do NOT need to change this unless you revoke the app "
            "password.",
        ],
    },
    "outlook": {
        ...
        "smtp_ssl": False,
        "smtp_tls": True,
        "help_url": "https://support.microsoft.com/en-us/office/pop-im"
        "ap-and-smtp-settings-8361e398-8af4-4e97-b147-6c6c4ac95353",
    ...
    "yahoo": {
        ...
        "smtp_ssl": True,
        "smtp_tls": False,
        "help_url": "https://help.yahoo.com/kb/generate-third-party-pa"
        "sswords-sln15241.html",
    ...
    "office365": {
        ...
        "smtp_ssl": False,
        "smtp_tls": True,
        "help_url": "https://learn.microsoft.com/en-us/exchange/mail-f"
        "low-best-practices/how-to-set-up-a-multifunction-device-or-"
        "application-to-send-email-using-microsoft-365-or-office-365",
        ...
        "help_steps": [
            ...
            "Use your regular O365 email and password (or an app password "
            "if MFA "
            "is enabled).",
        ],
    },
    "custom": {
        ...
        "help_steps": [
            ...
            "Enable STARTTLS if your server uses STARTTLS "
            "(port 587 typically).",
        ],
    },
    "log": {
        ...
        "help_steps": [
            ...
            "Verification codes are written to ~/.ari/admin/email/"
            "email_log.txt.",
...
def load_email_config() -> dict:
    ...
    if (
        str(cfg.get("smtp_password_enc", "")).strip()
...
def test_email_connection(
    cfg: Optional[dict] = None, quick_test: bool = False
) -> dict:
    """
...
def send_email(
    to_address: str, subject: str, body: str, cfg: Optional[dict] = None
) -> Optional[str]:
    """
    ...
    use_tls = bool(cfg.get("smtp_tls", False))
    from_addr = (
        str(cfg.get("from_address", "")).strip()
...
def send_verification_email(
    ...
    """Send a verification code email; return None on success."""
