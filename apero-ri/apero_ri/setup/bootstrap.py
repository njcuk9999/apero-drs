...
def has_admin_user(local_data_dir: Path, preferred_username: Optional[str] = None) -> bool:
...
def can_start_main_app(local_data_dir: Path) -> bool:
    return is_setup_complete(local_data_dir) or is_legacy_local_install(local_data_dir)
