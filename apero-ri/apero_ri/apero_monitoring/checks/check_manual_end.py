#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Reduced APERO check: manual trigger finished (MANUAL_END)."""
...
# Define variables
# =============================================================================
CHECK_NAME = 'MANUAL_END'
CHECK_HUMAN_NAME = 'Manual Trigger Finished'
CHECK_TYPE = 'red'
...
def check_function(instrument: str, obs_dir: str,
    ...
    """Return whether the manual trigger finished for this obsdir."""
