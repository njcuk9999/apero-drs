#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Reduced APERO check: ARI/LBL processing started (ARI_START)."""
...
# Define variables
# =============================================================================
CHECK_NAME = 'ARI_START'
CHECK_HUMAN_NAME = 'ARI Processing Started'
CHECK_TYPE = 'red'
...
def check_function(instrument: str, obs_dir: str,
    ...
    """Return whether ARI processing started for this obsdir."""
