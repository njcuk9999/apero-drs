#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Engineering check: cryo1 status state."""
...
CHECK_NAME = 'ENG_CRYO1_STATE'
# Human readable title shown in UI views.
CHECK_HUMAN_NAME = 'ENG: Cryo1 State'
...
CHECK.description = """
This engineering sub-test checks cryocooler 1 status for alarm state.
"""
