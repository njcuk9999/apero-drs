#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Reduced APERO check: manual trigger started (MANUAL_START)."""
...
# Define variables
# =============================================================================
CHECK_NAME = 'MANUAL_START'
CHECK_HUMAN_NAME = 'Manual Trigger Started'
CHECK_TYPE = 'red'
...
<CONTACT:C1> stating that you have re-run the manual trigger and the
...
def check_function(instrument: str, obs_dir: str,
    ...
    """Return whether the manual trigger started for this obsdir."""
