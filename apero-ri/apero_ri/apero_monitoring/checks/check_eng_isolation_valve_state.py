#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Engineering check: isolation valve state."""
...
# Define variables
# =============================================================================
CHECK_NAME = 'ENG_ISO_VALVE_STATE'
CHECK_HUMAN_NAME = 'ENG: Isolation Valve State'
CHECK_TYPE = 'raw'
...
def _to_bool(value: object) -> bool:
    """Convert a scalar value into bool."""
...
def check_function(instrument: str, obs_dir: str,
    ...
    """Run isolation-valve state validation for one observation directory.
    ...
    header_defs = dict()
    header_defs[key1] = dict(key=key1, dtype='bool')
