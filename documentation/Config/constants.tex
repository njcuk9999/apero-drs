...
\newcommand{\calDRIFTPEAK}{\definevariable{ch:the_recipes:cal_DRIFT_RAW_spirou}{cal\_DRIFT-PEAK\_E2DS\_spirou}}
...
\newcommand{\calvalidatecmd}{\definevariablecmd{cal\_validate\_spirou}}
...
\newcommand{\spirouBACK}{\ifdevguide \definevariable{ch:the_module:spirouBACK}\fi{SpirouDRS{\hskip 0pt}.spirouBACK{\hskip 0pt}.spirouBACK}}

\newcommand{\spirouCDB}{\ifdevguide \definevariable{ch:the_module:spirouCDB}\fi{SpirouDRS{\hskip 0pt}.spirouCDB{\hskip 0pt}.spirouCDB}}

\newcommand{\spirouConfig}{\ifdevguide \definevariable{ch:the_module:spirouConfig}\fi{SpirouDRS{\hskip 0pt}.spirouConfig{\hskip 0pt}.spirouConfig}}

\newcommand{\spirouConst}{\ifdevguide \definevariable{ch:the_module:spirouConfig}\fi{SpirouDRS{\hskip 0pt}.spirouConfig{\hskip 0pt}.spirouConst}}

\newcommand{\spirouEXTOR}{\ifdevguide \definevariable{ch:the_module:spirouEXTOR}\fi{SpirouDRS{\hskip 0pt}.spirouEXTOR{\hskip 0pt}.spirouEXTOR}}

\newcommand{\spirouFITS}{\ifdevguide \definevariable{ch:the_module:spirouImage}\fi{SpirouDRS{\hskip 0pt}.spirouImage{\hskip 0pt}.spirouFITS}}

\newcommand{\spirouImage}{\ifdevguide \definevariable{ch:the_module:spirouImage}\fi{SpirouDRS{\hskip 0pt}.spirouImage{\hskip 0pt}.spirouImage}}

\newcommand{\spirouLOCOR}{\ifdevguide \definevariable{ch:the_module:spirouLOCOR}\fi{SpirouDRS{\hskip 0pt}.spirouLOCOR{\hskip 0pt}.spirouLOCOR}}

\newcommand{\spirouLog}{\ifdevguide \definevariable{ch:the_module:spirouCore}\fi{SpirouDRS{\hskip 0pt}.spirouCore{\hskip 0pt}.spirouLog}}

\newcommand{\spirouPlot}{\ifdevguide \definevariable{ch:the_module:spirouCore}\fi{SpirouDRS{\hskip 0pt}.spirouCore{\hskip 0pt}.spirouPlot}}

\newcommand{\spirouRV}{\ifdevguide \definevariable{ch:the_module:spirouRV}\fi{SpirouDRS{\hskip 0pt}.spirouRV{\hskip 0pt}.spirouRV}}

\newcommand{\spirouStartup}{\ifdevguide \definevariable{ch:the_module:spirouStartup}\fi{SpirouDRS{\hskip 0pt}.spirouStartup{\hskip 0pt}.spirouStartup}}
...
\newcommand{\WLOG}{\definevariable{ch:rules:drs_specific:logger}{WLOG}}

\newcommand{\ParamDict}{\definevariable{ch:rules:drs_specific:param_dict}{ParamDict}}

\newcommand{\ConfigError}{\definevariable{ch:rules:drs_specific:config_error}{ConfigError}}

% variable the user should identify with their installation directory
\newcommand{\InstallDIR}{\definevariable{text:tdata}{TDATA}}

\newcommand{\InstallDIRcmd}{\definevariablecmd{TDATA}}
