...
This section describes all the NIRPS_HA recipe sequences to use with APERO. 
For information on individual recipes see :ref:`here <recipe_nirps_ha>`.


.. toctree::
    :maxdepth: 1
    :caption: Recipes (NIRPS_HA)
...
.. only:: html
  ...
  :ref:`Back to top <sequences_NIRPS_HA>`
