...
.. _recipes_nirps_he_wavem:


################################################################################
apero_wave_master_nirps_he
################################################################################
...
.. code-block:: 
    ...
    apero_wave_master_nirps_he.py {obs_dir}[STRING] --hcfiles[FILE:HCONE_HCONE] --fpfiles[FILE:FP_FP] {options}
...
.. code-block:: 
     ...
     --cavityfile[FILE:WAVEM_CAV] // [STRING] Define a custom cavity file (overrides default)
