...
This section describes all the default recipe sequences to use with APERO. 
For information on individual recipes see :ref:`here <recipe_default>`.


.. toctree::
    :maxdepth: 1
    :caption: Recipes (default)
...
.. only:: html
  ...
  :ref:`Back to top <sequences_default>`
