...
% ic_drift_type_raw
\item \ParameterEntry{Define the way to calculate the drift (for \calDRIFTRAW)}
{Defines the way to calculate the drift parameter should either be 'weighted mean' (Equation \ref{equation:drift_type_wmean_1}) or 'median' (Equation \ref{equation:drift_type_median_1}) for \calDRIFTRAW.
\begin{equation}
...
% ic_drift_type_e2ds
\item \ParameterEntry{Define the way to calculate the drift (for \calDRIFTE)}
{Defines the way to calculate the drift parameter should either be 'weighted mean' (Equation \ref{equation:drift_type_wmean_2}) or 'median' (Equation \ref{equation:drift_type_median_2}) for \calDRIFTE.
\begin{equation}
