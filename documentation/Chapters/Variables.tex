...
% qc_slit_min
\item \ParameterEntry{Minimum angle allowed for slit TILT}
{Defines the minimum tilt angle allowed to add TILT profile to the calibration databse. Value must be a float and must be less than \definevariable{qc\_slit\_max}}
{qc\_slit\_min}{-8.0}
{\calSLIT}{\constantsfile}{\calSLIT.\progMAIN}{Public}

% qc_slit_max
\item \ParameterEntry{Maximum angle allowed for slit TILT}
{Defines the maximum tiult angle allowed to add TILT profile to the calibration databse. Value must be a float and must be greater than \definevariable{qc\_slit\_min}}
{qc\_slit\_max}{0.0}
{\calSLIT}{\constantsfile}{\calSLIT.\progMAIN}{Public}
