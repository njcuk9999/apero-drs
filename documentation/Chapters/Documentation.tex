...
\begin{itemize}
	\item \textcolor{red}{\textbackslash{definevariable}} - used to create in-text variables i.e. \definevariable{VARIABLE}. i.e.:
	\begin{latexbox}
	The variable \definevariable{VARIABLE} can be used.
	\end{latexbox}


	\item \textcolor{red}{\textbackslash{definekeyword}} - used to create in-text keywords i.e. \definevariable{KEYWORD}. i.e.:
	\begin{latexbox}
	The keyword \definekeyword{KEYWORD} can be used.
	\end{latexbox}
...
\customdirtree{%
.1 home.
.2 \DTcomment{User directories here}.
}
\end{tcustomdir}
\end{latexbox}
\end{minipage}
