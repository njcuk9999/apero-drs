...
\begin{itemize}
	\item Write a setup.py installer / checker for prerequisites
	\item Need to sort out public and private variables (and keywords)
	\item Need to move user configuration file to, for example, \definevariable{/home/\$user/.spirou\_config} and call the default values from a private location
...
\begin{itemize}
	...
	\item Write Todo chapter \dotfill Dev
	\item \sout{Write coding style chapter} \dotfill Dev
	\item Write documentation chapter (writing the documentation) \dotfill Dev
