...
\item Python 3.6
	...
	\item \Program{matplotlib} (tested with version 2.0.2)
	\item \Program{numpy} (tested with version 1.12.1)
	\item \Program{scipy} (tested with version 0.19.0)
...
\item Python 2.7
	\begin{itemize}
	\item astropy (tested with version 1.2.1)
	\item matplotlib (tested with version 2.1.1)
	\item numpy (tested with version 1.13.3)
...
\begin{cmdbox}
python (*\calvalidatecmd*)
ipython (*\calvalidatecmd*)
\end{cmdbox}
